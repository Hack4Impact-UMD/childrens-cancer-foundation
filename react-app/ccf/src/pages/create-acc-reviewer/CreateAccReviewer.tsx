...
import { checkEmailReviewer, checkPasswordRequirements } from "../../utils/validation"; // Import the new functions
...
function AccountPageReviewers(): JSX.Element {
  ...
  const handleSubmit = async (e: any) => {
    ...
    const passwordRequirements = checkPasswordRequirements(pwd);
